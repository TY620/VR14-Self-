...
public:
	...
	void OnUpdateSessionResult(const TArray<FBlueprintSessionResult>& SessionResult); // 블루프린트에서

	void OnUpdateSessionResult_Implementation(const TArray<FBlueprintSessionResult>& SessionResult); // c++에서
